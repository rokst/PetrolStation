...
public class testDiesel {
    ...
    {
        static Fuel x = new Diesel("Diesel",0.5, 0.035);
        static Fuel y = new Diesel("Diesel",0.5, 0.035);
        static Fuel z = new Diesel("Diesel",0.5, 0.035);
        static Fuel a = new Diesel("Diesel",0.75, 0.0735);
    }
